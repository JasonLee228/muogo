package com.favorzip.muogo.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     */
    private List<ErrorResponse.ValidationError> getResultMessage(final Iterator<ConstraintViolation<?>> violationIterator) {
        List<ErrorResponse.ValidationError> errorList = new ArrayList<>();
        while (violationIterator.hasNext()) {
            final ConstraintViolation<?> constraintViolation = violationIterator.next();
            ErrorResponse.ValidationError error = ErrorResponse.ValidationError.builder()
